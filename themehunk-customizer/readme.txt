...
= 2.8.3 =
* Update: Bevro: Added in this plugin

= 2.8.2 =
* Update: WooCommerce condition removed from demo import.

= 2.8.1 =
* Update: onelinelite, shopline, featuredlite Theme tested with new importer.
