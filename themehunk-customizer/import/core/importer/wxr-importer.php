...
class HUNK_COMPAION_WXR_IMPORTER {
	...
	private function __construct() {
		...
		if ( ! class_exists( 'WP_Importer_Logger' ) ) {
			require_once THEMEHUNK_CUSTOMIZER_DIR_WEBSITE . 'core/importer/class-logger.php';
		}

		if ( ! class_exists( 'WP_Importer_Logger_ServerSentEvents' ) ) {
			require_once THEMEHUNK_CUSTOMIZER_DIR_WEBSITE . 'core/importer/class-wp-importer-logger-serversentevents.php';
		}

			//$this->elementor_competibilty();
		if ( ! class_exists( 'WXR_Importer' ) ) {
			require_once THEMEHUNK_CUSTOMIZER_DIR_WEBSITE . 'core/importer/class-wxr-importer.php';
		}

		if ( ! class_exists( 'WXR_Import_Info' ) ) {
			require_once THEMEHUNK_CUSTOMIZER_DIR_WEBSITE . 'core/importer/class-wxr-import-info.php';
		}
